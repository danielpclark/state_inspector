...
StateInspector::Reporter[Clt] = StateInspector::Observers::InternalObserver.new

class ClassLevelTest < Minitest::Test
  def observer; StateInspector::Reporter[Clt] end
